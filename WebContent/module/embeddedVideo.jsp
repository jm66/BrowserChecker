...
<bbNG:genericPage ctxId="ctx" title="Test Browser Video Sample Page">
    <%
    ...
    // get variables needed for navigation
        final String pageTitle = rBundle.getString("embeddedVideo.pageTitle");
        final String pageInstructions = rBundle.getString("embeddedVideo.pageInstructions");

        String paragraphTitleKey = "embeddedVideo." + fileRequested + ".paragraphTitle";
        String paragraphTitle = rBundle.getString(paragraphTitleKey);

        String bodyTextKey = "embeddedVideo." + fileRequested + ".bodyText";
        String bodyText = rBundle.getString(bodyTextKey);

        String contentIconKey = "embeddedVideo." + fileRequested + ".iconUrl";
        String contentIcon = rBundle.getString(contentIconKey); // e.g. ../samples/mov.png

        String contentUrlKey = "embeddedVideo." + fileRequested + ".contentUrl";
        String contentUrl = rBundle.getString(contentUrlKey); // e.g. ../samples/sample.mov

        String contentBodyKey = "embeddedVideo." + fileRequested + ".contentBody";
